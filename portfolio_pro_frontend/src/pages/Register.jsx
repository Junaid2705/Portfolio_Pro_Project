          ...
          <div className="success-card">
            ...
            <div className="success-icon-wrap">
              <svg className="success-svg" viewBox="0 0 80 80" fill="none">
                <circle cx="40" cy="40" r="38"
                  stroke="url(#successGrad)" strokeWidth="2"
                  strokeDasharray="239" strokeDashoffset="0"
                  style={{ animation: 'drawCircle 0.8s ease forwards' }}/>
                <path d="M24 40l12 12 20-24"
                  stroke="url(#successGrad)" strokeWidth="3"
            ...
            <div className="success-details">
              ...
              <div className="success-detail-row">
                ...
                <span className="success-detail-value" style={{ color: '#00c878' }}>Active</span>
              </div>
            </div>
            ...
            <div className="success-countdown">
              <div className="countdown-circle">
                <svg viewBox="0 0 50 50">
                  ...
                  <circle cx="25" cy="25" r="22" fill="none"
                    stroke="url(#cdGrad)" strokeWidth="3"
                    strokeLinecap="round"
              ...
              <p>Redirecting to login in <strong>{countdown} second{countdown !== 1 ? 's' : ''}</strong></p>
            </div>
      ...
      <div className={`auth-wrapper ${visible ? 'auth-visible' : ''}`}>
        <div className="auth-brand-panel">
          <div className="auth-logo">
            <div className="logo-hex">
              <svg viewBox="0 0 40 46" fill="none">
                <path d="M20 1L38 11.5V34.5L20 45L2 34.5V11.5L20 1Z"
                  stroke="url(#lg2)" strokeWidth="1.5" fill="url(#lgfill2)"/>
                <text x="20" y="28" textAnchor="middle" fill="white"
                  fontSize="14" fontWeight="700" fontFamily="Outfit,sans-serif">PP</text>
                <defs>
            ...
            <span className="logo-text">Portfolio<span>Pro</span></span>
          </div>
          ...
          <div className="brand-content">
            ...
            <p className="brand-sub">
              Join thousands of developers and designers showcasing
              their work with Portfolio Pro.
            </p>
            <div className="brand-steps">
              {[
                ...
                <div className="brand-step" key={i}
        ...
        <div className="auth-form-panel">
          <div className="glass-card">
            ...
            {errors.general && (
              <div className="form-error"><span>⚠</span> {errors.general}</div>
            )}
            ...
            <form onSubmit={handleSubmit} className="auth-form" noValidate>
              ...
              <div className="field">
                ...
                <div className={`input-wrap ${errors.email ? 'input-error' : ''}`}>
                  <span className="input-icon">
                    <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.5">
                      <path d="M2 5l8 6 8-6M2 5h16v12H2z" strokeLinejoin="round"/>
                    </svg>
                  </span>
              ...
              <div className="field">
                ...
                {form.password && (
                  <div className="strength-bar">
                    ...
                    <span style={{ color: S_COLOR[strength], fontSize: 11, minWidth: 64 }}>
                      {S_LABEL[strength]}
                    </span>
                  </div>
                )}
